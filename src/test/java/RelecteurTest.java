...
public class RelecteurTest {
    ...
    @Test
    public void only_three_persons_in_list_should_return_the_rest_relececteurs_without_demandeur() {
    ...
    @Test
    public void more_than_three_persons_in_list_should_return_two_relececteurs_without_demandeur() {
